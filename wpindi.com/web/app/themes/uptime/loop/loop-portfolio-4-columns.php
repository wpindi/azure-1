...
<div class="row" data-isotope-collection data-isotope-id="projects">	
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<div id="portfolio-<?php the_ID(); ?>" <?php post_class( 'col-sm-6 col-lg-3 mb-4' ); ?> data-isotope-item data-category="<?php echo esc_attr( TommusRhodus_Framework()->the_terms( $post->ID, 'portfolio_category', 'name', ' ' ) ); ?>">
